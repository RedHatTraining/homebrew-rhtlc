cask "rhtlc-gui" do
  ...
  if Hardware::CPU.intel?
    url "https://github.com/RedHatTraining/dle-wstunnel-ole/releases/download/v3.4.1/rhtlc-gui-macos-x86_64.zip"
    sha256 "81418c334ae82cc6966e2d13e254b12f8c6f2d935218113e050a69599ce66200"
  else
    url "https://github.com/RedHatTraining/dle-wstunnel-ole/releases/download/v3.4.1/rhtlc-gui-macos-arm64.zip"
